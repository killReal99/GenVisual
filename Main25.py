...
with open('TwentyFiveYear\\Convolution25.csv', 'r') as csvfile:
    ...
    for row in csvreader:
        ...
        Economic_damage_rza.append(189444112)
        Economic_damage_min.append(217387072)
        # Economic_damage_max.append(8394662400)
        Economic_damage_max_first.append(645683840)
        Costs_min.append(171950000)
        Costs_max.append(220932688)

plt.plot(Iteration_line, Economic_damage_min, label='Minimal damage')
# plt.plot(Iteration_line, Economic_damage_max, label='Максимальный ущерб (3 архитектура)')
plt.plot(Iteration_line, Economic_damage_max_first, label='Maximum damage')
plt.plot(Iteration_convolution, Economic_damage_convolution, label='Convolution method (equal weights)')
plt.plot(Iteration_convolution_direct, Economic_damage_convolution_direct, label='Convolution method (directly proportional weights)')
plt.plot(Iteration_convolution_reverse, Economic_damage_convolution_reverse, label='Convolution method (inversely proportional weights)')
plt.plot(Iteration_main, Economic_damage_main, label='Main criterion method')
plt.plot(Iteration_target, Economic_damage_target, label='Target programming method')
plt.plot(Iteration_line, Economic_damage_rza, label='Damage excluding computer attacks')
plt.title('Change in economic damage from unreliability')
plt.xlabel('Iteration number')
plt.ylabel('Economic damage from unreliability, million rubles')
plt.legend(loc="best")
ax = plt.gca()
...
plt.plot(Iteration_line, Costs_min, label='Minimal costs for secondary subsystems')
plt.plot(Iteration_line, Costs_max, label='Maximum costs for secondary subsystems')
plt.plot(Iteration_convolution, Costs_convolution, label='Convolution method (equal weights)')
plt.plot(Iteration_convolution_direct, Costs_convolution_direct, label='Convolution method (directly proportional weights)')
plt.plot(Iteration_convolution_reverse, Costs_convolution_reverse, label='Convolution method (inversely proportional weights)')
plt.plot(Iteration_main, Costs_main, label='Main criterion method')
plt.plot(Iteration_target, Costs_target, label='Target programming method')
plt.title('Change in the amount of capital and operating costs')
plt.xlabel('Iteration number')
plt.ylabel('Total capital and operating costs, million rubles')
plt.legend(loc="best")
